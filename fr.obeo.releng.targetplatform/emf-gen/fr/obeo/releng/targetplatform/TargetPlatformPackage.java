...
public interface TargetPlatformPackage extends EPackage
{
   ...
   * @ordered
   */
  int ENVIRONMENT__OPERATING_SYSTEM = TARGET_CONTENT_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int ENVIRONMENT__WINDOWING_SYSTEM = TARGET_CONTENT_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int ENVIRONMENT__ARCHITECTURE = TARGET_CONTENT_FEATURE_COUNT + 2;
   ...
   * @ordered
   */
  int ENVIRONMENT__LOCALIZATION = TARGET_CONTENT_FEATURE_COUNT + 3;
   ...
   * @ordered
   */
  int ENVIRONMENT__EXECUTION_ENVIRONMENT = TARGET_CONTENT_FEATURE_COUNT + 4;
   ...
   * @ordered
   */
  int ENVIRONMENT_FEATURE_COUNT = TARGET_CONTENT_FEATURE_COUNT + 5;
