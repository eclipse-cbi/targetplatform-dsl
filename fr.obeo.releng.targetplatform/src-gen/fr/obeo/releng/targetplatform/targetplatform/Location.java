 ...
 * </p>
 *
 * @see fr.obeo.releng.targetplatform.targetplatform.TargetplatformPackage#getLocation()
 * @model
 * @generated
 */
public interface Location extends EObject
{
   ...
   * @see #setUri(String)
   * @see fr.obeo.releng.targetplatform.targetplatform.TargetplatformPackage#getLocation_Uri()
   * @model
   * @generated
   */
  String getUri();
  ...
  /**
   * Sets the value of the '{@link fr.obeo.releng.targetplatform.targetplatform.Location#getUri <em>Uri</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see fr.obeo.releng.targetplatform.targetplatform.TargetplatformPackage#getLocation_Options()
   * @model unique="false"
   * @generated
   */
   ...
   * The list contents are of type {@link fr.obeo.releng.targetplatform.targetplatform.IU}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see fr.obeo.releng.targetplatform.targetplatform.TargetplatformPackage#getLocation_Ius()
