...
public class TargetPlatformPackageImpl extends EPackageImpl implements TargetPlatformPackage {
	 ...
	 * @see org.eclipse.cbi.targetplatform.TargetPlatformPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEClass(iuEClass, org.eclipse.cbi.targetplatform.IU.class, "IU", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getIU_ID(), theEcorePackage.getEString(), "ID", null, 0, 1, org.eclipse.cbi.targetplatform.IU.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getIU_Version(), theEcorePackage.getEString(), "version", null, 0, 1, org.eclipse.cbi.targetplatform.IU.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getIU_Location(), this.getLocation(), this.getLocation_Ius(), "location", null, 0, 1, org.eclipse.cbi.targetplatform.IU.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
