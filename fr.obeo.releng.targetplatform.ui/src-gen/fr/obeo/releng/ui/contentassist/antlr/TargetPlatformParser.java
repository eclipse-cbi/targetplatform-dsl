...
* generated by Xtext
*/
package fr.obeo.releng.ui.contentassist.antlr;
...
public class TargetPlatformParser extends AbstractContentAssistParser {
	...
	@Override
	protected fr.obeo.releng.ui.contentassist.antlr.internal.InternalTargetPlatformParser createParser() {
		fr.obeo.releng.ui.contentassist.antlr.internal.InternalTargetPlatformParser result = new fr.obeo.releng.ui.contentassist.antlr.internal.InternalTargetPlatformParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getTargetPlatformAccess().getLocationsAssignment_2(), "rule__TargetPlatform__LocationsAssignment_2");
					put(grammarAccess.getLocationAccess().getUriAssignment_1(), "rule__Location__UriAssignment_1");
					...
					put(grammarAccess.getIUAccess().getVersionAssignment_1_3(), "rule__IU__VersionAssignment_1_3");
				}
			};
		}
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			fr.obeo.releng.ui.contentassist.antlr.internal.InternalTargetPlatformParser typedParser = (fr.obeo.releng.ui.contentassist.antlr.internal.InternalTargetPlatformParser) parser;
